...
class PdfRenderer
{
     ...
     * @param 'document_master_list'|'document_reviews'|'activity_status'|null    $reportType     Together with $centre, resolves and stamps the configured PDF template as the background of every page (see PdfTemplateResolver).
     */
