...
class PdfRenderer
{
     ...
     * @param 'document_master_list'|'document_reviews'|'activity_status'|'read_acknowledgements'|'findings'|'improvement_plan'|'indicators'|'audit_program'|'audit_report'|null $reportType   Together with $centre, resolves and stamps the configured PDF template as the background of every page (see PdfTemplateResolver).
     */
     ...
     *
     * @param 'document_master_list'|'document_reviews'|'activity_status'|'read_acknowledgements'|'findings'|'improvement_plan'|'indicators'|'audit_program'|'audit_report' $reportType
     */
