...
**Curso**
: Nivel educativo dentro de un curso académico (p. ej. «1º ESO»), que agrupa uno o varios grupos.

**Grupo**
: Grupo-clase dentro de un curso (p. ej. «1ºESO-A»), con sus docentes (y la materia que imparte
cada uno) y sus tutores.
