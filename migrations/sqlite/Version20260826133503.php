...
final class Version20260826133503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id BLOB NOT NULL, name VARCHAR(255) NOT NULL, details CLOB DEFAULT NULL, academic_year_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_169E6FB9C54F3401 FOREIGN KEY (academic_year_id) REFERENCES academic_year (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE specific_profile (id BLOB NOT NULL, name VARCHAR(255) NOT NULL, position INTEGER NOT NULL, parent_id BLOB DEFAULT NULL, educational_centre_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_72B5CDE4727ACA70 FOREIGN KEY (parent_id) REFERENCES specific_profile (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_72B5CDE461F9EE23 FOREIGN KEY (educational_centre_id) REFERENCES educational_centre (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE specific_profile_teacher (specific_profile_id BLOB NOT NULL, teacher_id BLOB NOT NULL, PRIMARY KEY (specific_profile_id, teacher_id), CONSTRAINT FK_A7FBA311DF5533E FOREIGN KEY (specific_profile_id) REFERENCES specific_profile (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A7FBA31141807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE "group" (id BLOB NOT NULL, name VARCHAR(255) NOT NULL, details CLOB DEFAULT NULL, course_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_6DC044C5591CC992 FOREIGN KEY (course_id) REFERENCES course (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_6DC044C5591CC992 ON "group" (course_id)');
        $this->addSql('CREATE TABLE group_tutor (group_id BLOB NOT NULL, teacher_id BLOB NOT NULL, PRIMARY KEY (group_id, teacher_id), CONSTRAINT FK_C92B6D2FFE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C92B6D2F41807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE group_teacher (id BLOB NOT NULL, subject VARCHAR(255) NOT NULL, group_id BLOB NOT NULL, teacher_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_36F6F2D9FE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36F6F2D941807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE school_event_group (school_event_id BLOB NOT NULL, group_id BLOB NOT NULL, PRIMARY KEY (school_event_id, group_id), CONSTRAINT FK_7FDDC7598FB1DCCF FOREIGN KEY (school_event_id) REFERENCES school_event (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7FDDC759FE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
