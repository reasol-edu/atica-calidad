...
final class Version20260910120000 extends AbstractMigration
{
    ...
    {
        return 'Plazos estrictos de actividad: start/end date enforced y extensión de plazo (PostgreSQL)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD start_date_enforced BOOLEAN DEFAULT FALSE NOT NULL');
        $this->addSql('ALTER TABLE activity ADD end_date_enforced BOOLEAN DEFAULT FALSE NOT NULL');
