...
[configurado y activo](08-administrar-la-plataforma.md#correo-electronico-del-servidor), y que el
worker (Messenger) está en marcha — ver
[Correos en cola](08-administrar-la-plataforma.md#correos-en-cola-messenger).
...
[Administrar la plataforma](08-administrar-la-plataforma.md)) para identificar el error concreto.
