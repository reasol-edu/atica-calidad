...
final class Version20260826133453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, details LONGTEXT DEFAULT NULL, academic_year_id BINARY(16) NOT NULL, INDEX IDX_169E6FB9C54F3401 (academic_year_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE specific_profile (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, position INT NOT NULL, parent_id BINARY(16) DEFAULT NULL, educational_centre_id BINARY(16) NOT NULL, INDEX IDX_72B5CDE4727ACA70 (parent_id), INDEX IDX_72B5CDE461F9EE23 (educational_centre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE specific_profile_teacher (specific_profile_id BINARY(16) NOT NULL, teacher_id BINARY(16) NOT NULL, INDEX IDX_A7FBA311DF5533E (specific_profile_id), INDEX IDX_A7FBA31141807E1D (teacher_id), PRIMARY KEY (specific_profile_id, teacher_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `group` (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, details LONGTEXT DEFAULT NULL, course_id BINARY(16) NOT NULL, INDEX IDX_6DC044C5591CC992 (course_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE group_tutor (group_id BINARY(16) NOT NULL, teacher_id BINARY(16) NOT NULL, INDEX IDX_C92B6D2FFE54D947 (group_id), INDEX IDX_C92B6D2F41807E1D (teacher_id), PRIMARY KEY (group_id, teacher_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE group_teacher (id BINARY(16) NOT NULL, subject VARCHAR(255) NOT NULL, group_id BINARY(16) NOT NULL, teacher_id BINARY(16) NOT NULL, INDEX IDX_36F6F2D9FE54D947 (group_id), INDEX IDX_36F6F2D941807E1D (teacher_id), UNIQUE INDEX uq_group_teacher_subject (group_id, teacher_id, subject), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE school_event_group (school_event_id BINARY(16) NOT NULL, group_id BINARY(16) NOT NULL, INDEX IDX_7FDDC7598FB1DCCF (school_event_id), INDEX IDX_7FDDC759FE54D947 (group_id), PRIMARY KEY (school_event_id, group_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE course ADD CONSTRAINT FK_169E6FB9C54F3401 FOREIGN KEY (academic_year_id) REFERENCES academic_year (id)');
        ...
        $this->addSql('ALTER TABLE group_teacher ADD CONSTRAINT FK_36F6F2D9FE54D947 FOREIGN KEY (group_id) REFERENCES `group` (id)');
        $this->addSql('ALTER TABLE group_teacher ADD CONSTRAINT FK_36F6F2D941807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course DROP FOREIGN KEY FK_169E6FB9C54F3401');
        ...
        $this->addSql('ALTER TABLE specific_profile DROP FOREIGN KEY FK_72B5CDE4727ACA70');
        $this->addSql('ALTER TABLE specific_profile DROP FOREIGN KEY FK_72B5CDE461F9EE23');
        $this->addSql('ALTER TABLE specific_profile_teacher DROP FOREIGN KEY FK_A7FBA311DF5533E');
        $this->addSql('ALTER TABLE specific_profile_teacher DROP FOREIGN KEY FK_A7FBA31141807E1D');
        ...
        $this->addSql('ALTER TABLE group_tutor DROP FOREIGN KEY FK_C92B6D2FFE54D947');
        $this->addSql('ALTER TABLE group_tutor DROP FOREIGN KEY FK_C92B6D2F41807E1D');
        ...
        $this->addSql('ALTER TABLE school_event_group DROP FOREIGN KEY FK_7FDDC7598FB1DCCF');
        $this->addSql('ALTER TABLE school_event_group DROP FOREIGN KEY FK_7FDDC759FE54D947');
