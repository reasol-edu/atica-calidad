...
html: true
title: ÁTICA Calidad — Ficha rápida — Configurar un curso académico nuevo
...
<div class="step">
  <span class="num">1</span>
  <div class="text">
    <p>Desde <strong>Centro educativo › Docentes del centro › Importar desde Séneca</strong>, sube el CSV
...
<div class="nota">
  <p>Una vez declarados, se reflejan en el calendario del centro.</p>
</div>
