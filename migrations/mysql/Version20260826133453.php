...
final class Version20260826133453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE list_item (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, position INT NOT NULL, active TINYINT NOT NULL, parent_id BINARY(16) DEFAULT NULL, educational_centre_id BINARY(16) NOT NULL, associated_profile_id BINARY(16) DEFAULT NULL, associated_profile_list_item_id BINARY(16) DEFAULT NULL, INDEX IDX_5AD5FAF7727ACA70 (parent_id), INDEX IDX_5AD5FAF761F9EE23 (educational_centre_id), INDEX IDX_5AD5FAF7274D33F9 (associated_profile_id), INDEX IDX_5AD5FAF740EE1903 (associated_profile_list_item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE folder (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, position INT NOT NULL, group_by_profile TINYINT NOT NULL, auto_archive TINYINT NOT NULL, obsolete TINYINT NOT NULL, document_section_id BINARY(16) NOT NULL, INDEX IDX_ECA209CD79E0482C (document_section_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE folder_responsible_profile (id BINARY(16) NOT NULL, folder_id BINARY(16) NOT NULL, specific_profile_id BINARY(16) NOT NULL, list_item_id BINARY(16) DEFAULT NULL, INDEX IDX_7B7BF33D162CB942 (folder_id), INDEX IDX_7B7BF33DDF5533E (specific_profile_id), INDEX IDX_7B7BF33DCE208F53 (list_item_id), UNIQUE INDEX uq_folder_responsible_profile (folder_id, specific_profile_id, list_item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE folder_upload_profile (id BINARY(16) NOT NULL, folder_id BINARY(16) NOT NULL, specific_profile_id BINARY(16) NOT NULL, list_item_id BINARY(16) DEFAULT NULL, INDEX IDX_70EA7E24162CB942 (folder_id), INDEX IDX_70EA7E24DF5533E (specific_profile_id), INDEX IDX_70EA7E24CE208F53 (list_item_id), UNIQUE INDEX uq_folder_upload_profile (folder_id, specific_profile_id, list_item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE folder_visibility_profile (id BINARY(16) NOT NULL, folder_id BINARY(16) NOT NULL, specific_profile_id BINARY(16) NOT NULL, list_item_id BINARY(16) DEFAULT NULL, INDEX IDX_9B4F964F162CB942 (folder_id), INDEX IDX_9B4F964FDF5533E (specific_profile_id), INDEX IDX_9B4F964FCE208F53 (list_item_id), UNIQUE INDEX uq_folder_visibility_profile (folder_id, specific_profile_id, list_item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE folder_review_profile (id BINARY(16) NOT NULL, folder_id BINARY(16) NOT NULL, specific_profile_id BINARY(16) NOT NULL, list_item_id BINARY(16) DEFAULT NULL, INDEX IDX_2E33D03D162CB942 (folder_id), INDEX IDX_2E33D03DDF5533E (specific_profile_id), INDEX IDX_2E33D03DCE208F53 (list_item_id), UNIQUE INDEX uq_folder_review_profile (folder_id, specific_profile_id, list_item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE document_file (id BINARY(16) NOT NULL, hash VARCHAR(64) NOT NULL, content LONGBLOB NOT NULL, mime_type VARCHAR(100) NOT NULL, original_filename VARCHAR(255) NOT NULL, size INT NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX uq_document_file_hash (hash), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE document (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, uploaded_at DATETIME NOT NULL, position INT NOT NULL, folder_id BINARY(16) NOT NULL, upload_profile_id BINARY(16) DEFAULT NULL, upload_list_item_id BINARY(16) DEFAULT NULL, active_revision_id BINARY(16) DEFAULT NULL, INDEX IDX_D8698A76162CB942 (folder_id), INDEX IDX_D8698A766716B003 (upload_profile_id), INDEX IDX_D8698A76F1C99108 (upload_list_item_id), INDEX IDX_D8698A76490589C4 (active_revision_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE document_revision (id BINARY(16) NOT NULL, version INT NOT NULL, revised_at DATETIME NOT NULL, pending_review TINYINT NOT NULL, description LONGTEXT DEFAULT NULL, rejected TINYINT NOT NULL, review_result LONGTEXT DEFAULT NULL, document_id BINARY(16) NOT NULL, reviewed_by_id BINARY(16) DEFAULT NULL, file_id BINARY(16) NOT NULL, uploaded_by_id BINARY(16) NOT NULL, INDEX IDX_E2A2E495C33F7837 (document_id), INDEX IDX_E2A2E495FC6B21F1 (reviewed_by_id), INDEX IDX_E2A2E49593CB796C (file_id), INDEX IDX_E2A2E495A2B28FE8 (uploaded_by_id), UNIQUE INDEX uq_document_revision_version (document_id, version), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE folder ADD CONSTRAINT FK_ECA209CD79E0482C FOREIGN KEY (document_section_id) REFERENCES document_section (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_responsible_profile ADD CONSTRAINT FK_7B7BF33D162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_responsible_profile ADD CONSTRAINT FK_7B7BF33DDF5533E FOREIGN KEY (specific_profile_id) REFERENCES specific_profile (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_responsible_profile ADD CONSTRAINT FK_7B7BF33DCE208F53 FOREIGN KEY (list_item_id) REFERENCES list_item (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_upload_profile ADD CONSTRAINT FK_70EA7E24162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_upload_profile ADD CONSTRAINT FK_70EA7E24DF5533E FOREIGN KEY (specific_profile_id) REFERENCES specific_profile (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_upload_profile ADD CONSTRAINT FK_70EA7E24CE208F53 FOREIGN KEY (list_item_id) REFERENCES list_item (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_visibility_profile ADD CONSTRAINT FK_9B4F964F162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_visibility_profile ADD CONSTRAINT FK_9B4F964FDF5533E FOREIGN KEY (specific_profile_id) REFERENCES specific_profile (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_visibility_profile ADD CONSTRAINT FK_9B4F964FCE208F53 FOREIGN KEY (list_item_id) REFERENCES list_item (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_review_profile ADD CONSTRAINT FK_2E33D03D162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_review_profile ADD CONSTRAINT FK_2E33D03DDF5533E FOREIGN KEY (specific_profile_id) REFERENCES specific_profile (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE folder_review_profile ADD CONSTRAINT FK_2E33D03DCE208F53 FOREIGN KEY (list_item_id) REFERENCES list_item (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE document ADD CONSTRAINT FK_D8698A766716B003 FOREIGN KEY (upload_profile_id) REFERENCES specific_profile (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE document ADD CONSTRAINT FK_D8698A76F1C99108 FOREIGN KEY (upload_list_item_id) REFERENCES list_item (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE document ADD CONSTRAINT FK_D8698A76490589C4 FOREIGN KEY (active_revision_id) REFERENCES document_revision (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE document_revision ADD CONSTRAINT FK_E2A2E495C33F7837 FOREIGN KEY (document_id) REFERENCES document (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE document_revision ADD CONSTRAINT FK_E2A2E495FC6B21F1 FOREIGN KEY (reviewed_by_id) REFERENCES teacher (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE document_revision ADD CONSTRAINT FK_E2A2E49593CB796C FOREIGN KEY (file_id) REFERENCES document_file (id)');
        $this->addSql('ALTER TABLE document_revision ADD CONSTRAINT FK_E2A2E495A2B28FE8 FOREIGN KEY (uploaded_by_id) REFERENCES teacher (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE list_item DROP FOREIGN KEY FK_5AD5FAF7274D33F9');
        $this->addSql('ALTER TABLE list_item DROP FOREIGN KEY FK_5AD5FAF740EE1903');
        ...
        $this->addSql('ALTER TABLE folder DROP FOREIGN KEY FK_ECA209CD79E0482C');
        $this->addSql('ALTER TABLE folder_responsible_profile DROP FOREIGN KEY FK_7B7BF33D162CB942');
        $this->addSql('ALTER TABLE folder_responsible_profile DROP FOREIGN KEY FK_7B7BF33DDF5533E');
        $this->addSql('ALTER TABLE folder_responsible_profile DROP FOREIGN KEY FK_7B7BF33DCE208F53');
        $this->addSql('ALTER TABLE folder_upload_profile DROP FOREIGN KEY FK_70EA7E24162CB942');
        $this->addSql('ALTER TABLE folder_upload_profile DROP FOREIGN KEY FK_70EA7E24DF5533E');
        $this->addSql('ALTER TABLE folder_upload_profile DROP FOREIGN KEY FK_70EA7E24CE208F53');
        $this->addSql('ALTER TABLE folder_visibility_profile DROP FOREIGN KEY FK_9B4F964F162CB942');
        $this->addSql('ALTER TABLE folder_visibility_profile DROP FOREIGN KEY FK_9B4F964FDF5533E');
        $this->addSql('ALTER TABLE folder_visibility_profile DROP FOREIGN KEY FK_9B4F964FCE208F53');
        $this->addSql('ALTER TABLE folder_review_profile DROP FOREIGN KEY FK_2E33D03D162CB942');
        $this->addSql('ALTER TABLE folder_review_profile DROP FOREIGN KEY FK_2E33D03DDF5533E');
        $this->addSql('ALTER TABLE folder_review_profile DROP FOREIGN KEY FK_2E33D03DCE208F53');
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A76162CB942');
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A766716B003');
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A76F1C99108');
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A76490589C4');
        $this->addSql('ALTER TABLE document_revision DROP FOREIGN KEY FK_E2A2E495C33F7837');
        $this->addSql('ALTER TABLE document_revision DROP FOREIGN KEY FK_E2A2E495FC6B21F1');
        $this->addSql('ALTER TABLE document_revision DROP FOREIGN KEY FK_E2A2E49593CB796C');
