...
| Recordatorio de revisión de documentos | Global, centro, personal | Una vez por semana (el primer día lectivo), la lista de documentos de las carpetas a cargo del docente con la [fecha de próxima revisión](07-arbol-documental.md#renombrar-mover-y-eliminar-documentos) vencida o cerca. Si una carpeta no tiene responsables, lo reciben los responsables de calidad del centro. |
| Días de preaviso de la revisión de documentos | Global, centro, personal | Con cuántos días de antelación (30 por defecto) empieza a incluirse un documento en ese recordatorio, además de los ya vencidos. |
