...
final class Version20260831160000 extends AbstractMigration
{
    ...
    {
        return 'Ajuste de aviso de documento pendiente de revisar, a nivel global, de centro y personal (PostgreSQL)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, key, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (gen_random_uuid(), 'notifications.pending_review_reminder_enabled', 'boolean', 'true', TRUE, TRUE, TRUE, NULL, NULL, 'settings.category.email_alerts', 10, 60)
        SQL);
    }
