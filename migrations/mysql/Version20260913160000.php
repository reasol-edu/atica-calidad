...
final class Version20260913160000 extends AbstractMigration
{
    ...
    {
        return 'Ajuste notifications.email_subject_prefix, a nivel global y de centro (MySQL / MariaDB)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, `key`, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (UNHEX(REPLACE(UUID(), '-', '')), 'notifications.email_subject_prefix', 'string', '', 1, 1, 0, NULL, 50, 'settings.category.email_alerts', 10, 90)
        SQL);
    }
