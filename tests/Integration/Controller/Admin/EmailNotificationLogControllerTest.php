...
final class EmailNotificationLogControllerTest extends ControllerTestCase
{
    ...
    public function testIndexDeniedForANonAdmin(): void
    {
        ...
        $this->client->request('GET', "/centro/{$centreId}/registro-avisos");
    ...
    public function testIndexReturns404ForAnUnknownCentre(): void
    {
        ...
        $this->loginAs($admin, $centre);
        $this->client->request('GET', '/centro/01945c2e-0000-7000-8000-000000000000/registro-avisos');
