...
final class Version20260826133453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE specific_profile (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, position INT NOT NULL, list_item_id BINARY(16) DEFAULT NULL, educational_centre_id BINARY(16) NOT NULL, INDEX IDX_72B5CDE4CE208F53 (list_item_id), INDEX IDX_72B5CDE461F9EE23 (educational_centre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
