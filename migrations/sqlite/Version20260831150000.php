...
final class Version20260831150000 extends AbstractMigration
{
    ...
    {
        return 'Ajuste de días de preaviso del recordatorio de actividad pendiente, a nivel global, de centro y personal (SQLite)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO setting_definition (id, key, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
            ('00000000-0000-4000-8000-000000000008', 'notifications.pending_activity_reminder_warning_days', 'integer', '5', 1, 1, 1, 0, 365, 'settings.category.email_alerts', 10, 50)
        ");
    }
