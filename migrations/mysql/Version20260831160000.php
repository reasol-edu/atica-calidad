...
final class Version20260831160000 extends AbstractMigration
{
    ...
    {
        return 'Ajuste de aviso de documento pendiente de revisar, a nivel global, de centro y personal (MySQL / MariaDB)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, `key`, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (UNHEX(REPLACE(UUID(), '-', '')), 'notifications.pending_review_reminder_enabled', 'boolean', 'true', 1, 1, 1, NULL, NULL, 'settings.category.email_alerts', 10, 60)
        SQL);
    }
